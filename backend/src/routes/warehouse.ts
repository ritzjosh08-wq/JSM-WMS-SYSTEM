...
const FLOOR_CONFIG: {zone:string;code:string}[] = [
  ...
  // "Floor near rack <letter>" markers — reconciled 2026-08-05 against the real FG Godown
  // Sheet (94,887 rows across 77 daily snapshots): workers record informal floor storage
  // next to a given rack as "<letter> RAK FLOOR" instead of a specific bin. These account
  // for 3,505+ real rows and were previously rejected by /api/warehouse/layout as invalid.
  {zone:"FLOOR",code:"A RAK FLOOR"},{zone:"FLOOR",code:"B RAK FLOOR"},{zone:"FLOOR",code:"H RAK FLOOR"},
  {zone:"FLOOR",code:"N RAK FLOOR"},{zone:"FLOOR",code:"O RAK FLOOR"},{zone:"FLOOR",code:"P RAK FLOOR"},
  {zone:"FLOOR",code:"PQ RAK FLOOR"},{zone:"FLOOR",code:"Q RAK FLOOR"},{zone:"FLOOR",code:"FLOOR"},
  {zone:"FLOOR",code:"A3-FLOOR"},{zone:"FLOOR",code:"L1-FLOOR"},{zone:"FLOOR",code:"LM2-FLOOR"},
];
...
const RACK_CONFIG: Record<string,Record<string,string[]>> = {
  RA: {
    ...
    RA3: ["RA3-01","RA3-02","RA3-03","RA3-04","RA3-05","RA3-06","RA3-07","RA3-08","RA3-09","RA3-10","RA3-11","RA3-12","RA3-13","RA3-14","RA3-15","RA3-16","RA3-17","RA3-18","RA3-19","RA3-20","RA3-21","RA3-22","RA3-23","RA3-24"],
  ...
  RN: {
    ...
    RN3: ["RN3-01","RN3-02","RN3-03","RN3-04","RN3-05","RN3-06","RN3-07","RN3-08","RN3-09","RN3-10","RN3-11","RN3-12","RN3-13","RN3-14","RN3-15","RN3-16","RN3-17","RN3-18","RN3-19","RN3-20","RN3-21","RN3-22","RN3-23","RN3-24","RN3-25","RN3-26","RN3-27","RN3-28","RN3-29","RN3-30","RN3-31","RN3-32","RN3-33","RN3-34"],
    RN4: ["RN4-01","RN4-02","RN4-03","RN4-04","RN4-05","RN4-06","RN4-07","RN4-08","RN4-09","RN4-10","RN4-11","RN4-13","RN4-14","RN4-15","RN4-16","RN4-17","RN4-18","RN4-19","RN4-20","RN4-21","RN4-22","RN4-25","RN4-26","RN4-27","RN4-28","RN4-29","RN4-30","RN4-31","RN4-32","RN4-33","RN4-34"],
  },
  RO: {
    ...
    RO3: ["RO3-01","RO3-02","RO3-03","RO3-04","RO3-05","RO3-06","RO3-07","RO3-08","RO3-09","RO3-11","RO3-12","RO3-13","RO3-14","RO3-15","RO3-16","RO3-17","RO3-18","RO3-19","RO3-20","RO3-21","RO3-22","RO3-23","RO3-24","RO3-25","RO3-26","RO3-27","RO3-28"],
    RO4: ["RO4-01","RO4-02","RO4-03","RO4-04","RO4-05","RO4-06","RO4-07","RO4-08","RO4-09","RO4-11","RO4-12","RO4-13","RO4-14","RO4-15","RO4-16","RO4-17","RO4-18","RO4-19","RO4-20","RO4-21","RO4-22","RO4-23","RO4-24","RO4-25","RO4-26","RO4-27","RO4-28"],
  },
  RP: {
    ...
    RP3: ["RP3-01","RP3-02","RP3-03","RP3-04","RP3-05","RP3-06","RP3-07","RP3-08","RP3-09","RP3-10","RP3-11","RP3-12","RP3-13","RP3-14","RP3-15","RP3-16","RP3-17","RP3-18","RP3-19","RP3-20","RP3-21","RP3-22","RP3-23","RP3-24","RP3-25","RP3-26","RP3-27","RP3-28"],
    RP4: ["RP4-01","RP4-02","RP4-03","RP4-04","RP4-05","RP4-06","RP4-07","RP4-08","RP4-09","RP4-11","RP4-12","RP4-13","RP4-14","RP4-15","RP4-16","RP4-17","RP4-18","RP4-19","RP4-20","RP4-21","RP4-22","RP4-23","RP4-24","RP4-25","RP4-26","RP4-27","RP4-28"],
  },
  RQ: {
    ...
    RQ3: ["RQ3-01","RQ3-02","RQ3-03","RQ3-04","RQ3-05","RQ3-06","RQ3-07","RQ3-09","RQ3-10","RQ3-11","RQ3-12","RQ3-13","RQ3-14","RQ3-15","RQ3-16","RQ3-17","RQ3-18","RQ3-19","RQ3-20","RQ3-21","RQ3-22","RQ3-23","RQ3-24","RQ3-25","RQ3-26","RQ3-27","RQ3-28","RQ3-29","RQ3-30"],
    RQ4: ["RQ4-01","RQ4-02","RQ4-03","RQ4-04","RQ4-05","RQ4-06","RQ4-07","RQ4-09","RQ4-10","RQ4-11","RQ4-12","RQ4-13","RQ4-14","RQ4-15","RQ4-16","RQ4-17","RQ4-18","RQ4-21","RQ4-22","RQ4-23","RQ4-24","RQ4-25","RQ4-26","RQ4-27","RQ4-28","RQ4-29","RQ4-30"],
  },
};
...
const FG05_FLOOR_CONFIG: {zone:string;code:string}[] = [
  ...
  // "3" sub-zones — reconciled 2026-08-05 against the real FG Godown Sheet (94,887 rows
  // across 77 daily snapshots). This list originally only had "1"/"2" sub-zones per letter,
  // but the actual warehouse floor uses a "3" sub-zone for every letter instead of "2" —
  // roughly half of all real FG05 rows (~28,000) use these codes and were being rejected
  // by /api/warehouse/layout as invalid. Bin counts per letter mirror the sheet's real usage.
  {zone:"C3",code:"C3-01"},{zone:"C3",code:"C3-02"},{zone:"C3",code:"C3-03"},{zone:"C3",code:"C3-04"},{zone:"C3",code:"C3-05"},
  {zone:"D3",code:"D3-01"},{zone:"D3",code:"D3-02"},{zone:"D3",code:"D3-03"},{zone:"D3",code:"D3-04"},{zone:"D3",code:"D3-05"},
  {zone:"E3",code:"E3-01"},{zone:"E3",code:"E3-02"},{zone:"E3",code:"E3-03"},{zone:"E3",code:"E3-04"},{zone:"E3",code:"E3-05"},
  {zone:"F3",code:"F3-01"},{zone:"F3",code:"F3-02"},{zone:"F3",code:"F3-03"},{zone:"F3",code:"F3-04"},{zone:"F3",code:"F3-05"},{zone:"F3",code:"F3-06"},
  {zone:"G3",code:"G3-01"},{zone:"G3",code:"G3-02"},{zone:"G3",code:"G3-03"},{zone:"G3",code:"G3-04"},{zone:"G3",code:"G3-05"},
  {zone:"H3",code:"H3-01"},{zone:"H3",code:"H3-02"},{zone:"H3",code:"H3-03"},{zone:"H3",code:"H3-04"},{zone:"H3",code:"H3-05"},
  {zone:"I3",code:"I3-01"},{zone:"I3",code:"I3-02"},{zone:"I3",code:"I3-03"},{zone:"I3",code:"I3-04"},{zone:"I3",code:"I3-05"},
  {zone:"J3",code:"J3-01"},{zone:"J3",code:"J3-02"},{zone:"J3",code:"J3-03"},{zone:"J3",code:"J3-04"},{zone:"J3",code:"J3-05"},
  {zone:"K3",code:"K3-01"},{zone:"K3",code:"K3-02"},{zone:"K3",code:"K3-03"},{zone:"K3",code:"K3-04"},
  {zone:"L3",code:"L3-01"},{zone:"L3",code:"L3-02"},{zone:"L3",code:"L3-03"},{zone:"L3",code:"L3-04"},
  // Generic floor marker — "FG-05 F" appears 2,282 times in the real sheet for bulk floor
  // stock not assigned to a specific bin.
  {zone:"FLOOR",code:"FG-05 F"},
];
