...
interface AuthState {
  ...
  setSession: (user: AuthUser, allowedCodes: string[]) => void;
...
export const useAuthStore = create<AuthState>((set) => ({
  ...
  setSession: (user, allowedCodes) => {
    ...
    set({ user, allowedCodes, team, selectedWorkerCode: null });
  },
  ...
  logout: () => {
    ...
    sessionStorage.removeItem(SEL_KEY);
    set({ user: null, allowedCodes: [], team: [], selectedWorkerCode: null });
  },
}));
